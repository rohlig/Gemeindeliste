...
namespace GemeindeJubilaen.Services
{
    class PDFExport
    {
        ...
        public FileInfo ExportAsPDF(List<Item> alleGemeindeglieder, bool nachVornamenSortieren = false)
        {
            ...
            doc.Add(GetGemeindeTable(alleGemeindeglieder, nachVornamenSortieren));
            doc.Close();
            return file;
        }
        ...
        private Table GetGemeindeTable(List<Item> alleGemeindeglieder, bool nachVornamenSortieren)
        {
            ...
            p.SetUnderline();
            p.Add("Gemeindeliste");
            table.AddCell(new Cell(1,4).Add(p).SetBorder(Border.NO_BORDER));
            var cell = new Cell().SetVerticalAlignment(VerticalAlignment.MIDDLE).SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            cell.Add(new Paragraph("Name").SetFont(boldFont).SetTextAlignment(TextAlignment.CENTER).SetFontSize(12f));
            table.AddCell(cell);

            cell = new Cell().SetVerticalAlignment(VerticalAlignment.MIDDLE).SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            cell.Add(new Paragraph("Geburtstag").SetFont(boldFont).SetTextAlignment(TextAlignment.CENTER).SetFontSize(12f));
            table.AddCell(cell);

            cell = new Cell().SetVerticalAlignment(VerticalAlignment.MIDDLE).SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            cell.Add(new Paragraph("Tauftag").SetFont(boldFont).SetTextAlignment(TextAlignment.CENTER).SetFontSize(12f));
            table.AddCell(cell);
            cell = new Cell().SetVerticalAlignment(VerticalAlignment.MIDDLE).SetBackgroundColor(ColorConstants.LIGHT_GRAY);
            cell.Add(new Paragraph("Status").SetFont(boldFont).SetTextAlignment(TextAlignment.CENTER).SetFontSize(12f));
            table.AddCell(cell);
            foreach (var item in alleGemeindeglieder.OrderBy(x => (nachVornamenSortieren)?x.Vorname:x.Nachname))
            {
                cell = new Cell().SetVerticalAlignment(VerticalAlignment.MIDDLE);
                cell.Add(new Paragraph(item.Name).SetFont(boldFont).SetTextAlignment(TextAlignment.CENTER).SetFontSize(10f));
                table.AddCell(cell);
                ...
                cell = new Cell().SetVerticalAlignment(VerticalAlignment.MIDDLE);
                cell.Add(new Paragraph(item.Geburtsdatum).SetFont(normalFont).SetTextAlignment(TextAlignment.CENTER).SetFontSize(10f));
                table.AddCell(cell);

                cell = new Cell().SetVerticalAlignment(VerticalAlignment.MIDDLE);
                cell.Add(new Paragraph(item.Taufdatum).SetFont(normalFont).SetTextAlignment(TextAlignment.CENTER).SetFontSize(10f));
                table.AddCell(cell);
